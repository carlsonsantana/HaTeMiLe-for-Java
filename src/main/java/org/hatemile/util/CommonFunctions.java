...
public final class CommonFunctions {
     ...
     */
    public static void setListAttributes(final HTMLDOMElement element1,
            final HTMLDOMElement element2, final String[] attributes) {
        for (int i = 0, length = attributes.length; i < length; i++) {
            if (element1.hasAttribute(attributes[i])) {
                element2.setAttribute(attributes[i],
                        element1.getAttribute(attributes[i]));
            }
        }
    }
     ...
     * in list.
     */
    public static String increaseInList(final String list,
            final String stringToIncrease) {
     ...
     */
    public static boolean inList(final String list,
